...
public class UsersController {
	...
	public List<Following> listaAllUsers() {
		List<Following> users = userRopository.findAllUsers();
	...
	public String removeFollowing(@PathVariable(value = "idRemove") Integer idRemove, @PathVariable(value = "idUser") Integer idUser) {
	...
	public String addFollowing(@PathVariable(value = "idAdd") Integer idAdd, @PathVariable(value = "idUser") Integer idUser) {
